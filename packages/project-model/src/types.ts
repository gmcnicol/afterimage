...
export type RuntimeFieldScalePreset = 'source' | 'full' | 'three-quarter' | 'half' | 'quarter' | 'eighth';
...
export type FieldGeneratorKind = 'clip-luma' | 'seeded-noise-drift' | 'external-live-source' | 'motion-frame-difference';
